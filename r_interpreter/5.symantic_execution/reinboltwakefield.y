...
%type <floatVal> T_FLOATCONST
%type <text> T_IDENT T_STRCONST T_FALSE T_TRUE
...
N_START         : N_EXPR
                {
                    ...
                    printf("\n---- Completed parsing ----\n\n");
		            printf("Value of the expression is: %s",returnVal($1).c_str());
                    return 0;
                }
                ;
N_EXPR          : N_IF_EXPR
...
N_CONST         : T_INTCONST
                ...
                | T_STRCONST
                {
                    ...
                    $$.returnType = NOT_APPLICABLE;
                    $$.isParam = false;
                    string lexeme = string($1); // these next few lines are making a deep copy
...
N_FOR_EXPR      : T_FOR T_LPAREN T_IDENT 
			...
			T_RPAREN N_EXPR
			{
                    ...
                    $$.floatVal = $9.floatVal;
                    $$.boolVal = $9.boolVal;
                    $$.stringVal = $9.stringVal;
                    $$.listVal = $9.listVal;
			}
                ;

N_LIST_EXPR     : T_LIST {listGlobal = new vector<LISTENTRY>;} T_LPAREN N_CONST_LIST T_RPAREN
                {
                    printRule("LIST_EXPR", 
                              "LIST ( CONST_LIST )");
                    $$.type = LIST;
...
N_CONST_LIST    : N_CONST T_COMMA N_CONST_LIST
			...
			LISTENTRY temp = {$1.type,$1.intVal,$1.floatVal,$1.boolVal, $1.stringVal};
